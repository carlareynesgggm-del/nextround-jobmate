...
function NotesPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Notas" description={`${notes.length} notas guardadas.`} />
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <div>
            ...
            <Input
              ...
              placeholder="Feedback de la 2ª ronda"
              className="mt-1.5"
            />
          </div>
          <div>
            <Label htmlFor="n-app">Candidatura</Label>
            <select
              id="n-app"
              value={applicationId}
          ...
          <div className="md:col-span-2">
            <Label htmlFor="n-body">Contenido</Label>
            <Textarea
              id="n-body"
              value={body}
      ...
      {notes.length === 0 ? (
        <EmptyState
          title="Sin notas"
          description="Apunta lo que aprendes en cada conversación."
